...
**PortalPFK** — це мобільний додаток для Android, розроблений на базі кросплатформного фреймворку Flet. Головною метою застосунку є забезпечення студентів ВСП "Професійно-педагогічний фаховий коледж Національного університету кораблебудування імені адмірала Макарова" (ВСП ПФК НУК) зручним та оперативним доступом до актуальної інформації з офіційного веб-сайту коледжу. Додаток автоматично парсить та оновлює дані, централізуючи ключову інформацію для студентів.

## Основні Функції

* **Останні Новини:** Швидкий доступ до оголошень та новин коледжу.
...
* **Git:** Система контролю версій для управління кодом проєкту.
* **GitHub:** Платформа для хостингу Git-репозиторіїв та спільної розробки.
...
* **Python 3.8+:** Встановіть Python на вашу систему. Рекомендується використовувати останню стабільну версію.
